...
function StepBody(props: ReturnType<typeof useEvaluator>) {
  switch (props.step) {
    ...
    case "rubric":
      return (
        <RubricStep
          ...
          portfolioFiles={props.portfolioFiles}
          onPortfolioChange={props.setPortfolioFiles}
        />
      );
    case "configure":
      return (
        <ConfigureStep model={props.model} onModel={props.setModel} />
      );
    case "run":
      return (
        <ProgressStep
    ...
    case "results":
      return props.result ? (
        <ResultsStep result={props.result} onDownload={props.downloadPdf} />
      ) : (
        <ProgressStep
          stages={props.stages}
          partials={props.partials}
